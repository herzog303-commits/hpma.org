...
page("about/index.html", "About the Pointe", "About the Pointe",
    ...
    <div class="prose">
      ...
      <p>In 1970 Weyerhaeuser established Hartstene Pointe as a not-for-profit corporation. While Hartstene Pointe was originally planned to be a recreational community, a significant number of the homes serve as primary residences today. The Pointe consists of <strong>532 private residential lots</strong>, 90 of which are condominium &ldquo;Island Houses&rdquo;, along with a private road system, a 6,000&nbsp;sq.&nbsp;ft. Clubhouse, a swimming pool and hot tub, three tennis courts, a basketball court, a pickleball court, about 5.5 miles of walking trails, a 110-slip marina, a boat launch, picnic areas and 3.5 miles of private beach.</p>
...
amenity("marina.html","Marina","Marina","assets/img/pages/marina-decew.jpg",
 ...
 body="""  <section class="article"><div class="wrap"><div class="split">
    ...
    <aside class="aside">
      ...
      <h4 style="margin-top:20px">Live conditions</h4>
      <p>Current tides, currents and weather for Indian Cove, updated live.</p>
      <p><a class="btn" href="marina-board.html" target="_blank" rel="noopener">Tide &amp; Weather Board &#8599;</a></p>
...
page("visiting/index.html", "Visiting the Pointe", "Visiting the Pointe",
    ...
    <div class="callout"><h4>Questions?</h4><p>The owner you're visiting is your first point of contact for anything about the community and its amenities. If they can't help, the <a href="../contact/">HPMA office</a> is glad to.</p></div>
...
page("contact/index.html", "Contact", "Contact",
    ...
    <div class="contact-grid">
      <div class="contact-card">
        ...
        <div class="line"><b>General Manager</b><span><a href="tel:+13606145072">(360) 614-5072</a><br><a href="mailto:gm@hpma.org">gm@hpma.org</a></span></div>
